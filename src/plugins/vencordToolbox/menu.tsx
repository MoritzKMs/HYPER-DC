                        ...
                        >
                            {hasVisibleOptions && (
                                <>
                                    ...
                                    <Menu.MenuItem
                                        id={`${p.name}-open`}
                                        label={hyperTranslate("Open Settings")}
                                        action={() => openPluginModal(p)}
                                    />
                                </>
                            )}
    ...
    return (
        <>
            <Menu.MenuCheckboxItem
                id="toggle-quickcss"
                checked={useQuickCss}
                label={hyperTranslate("Enable QuickCSS")}
                action={() => {
            ...
            <Menu.MenuItem
                id="edit-quickcss"
                label={hyperTranslate("Edit QuickCSS")}
                action={() => VencordNative.quickCss.openEditor()}
            />
            <Menu.MenuItem
                id="manage-themes"
                label={hyperTranslate("Manage Themes")}
                action={() => openSettingsTabModal(ThemesTab)}
            />
            {!!themes?.length && (
                <Menu.MenuGroup>
...
export function renderPopout(onClose: () => void) {
    return (
        ...
        >
            <Menu.MenuItem
                id="notifications"
                label={hyperTranslate("Open Notification Log")}
