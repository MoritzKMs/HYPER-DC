...
export const settings = definePluginSettings({
    toolTip: {
        ...
        description: hyperTranslate("Show member count on the server tooltip"),
        default: true,
        restartNeeded: true
    },
    memberList: {
        type: OptionType.BOOLEAN,
        description: hyperTranslate("Show member count in the member list"),
        default: true,
        restartNeeded: true
    },
    voiceActivity: {
        type: OptionType.BOOLEAN,
        description: hyperTranslate("Show voice activity with member count in the member list"),
        default: true
    }
});
...
export default definePlugin({
    name: "MemberCount",
    description: hyperTranslate("Shows the number of online members, total members, and users in voice channels on the server — in the member list and tooltip."),
